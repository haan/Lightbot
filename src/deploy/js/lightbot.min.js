...
check:function(){return b(lightBot.medals.gold)===lightBot.map.getNbrOfLevels()}}],hasAchievement:function(a){return localStorage.getItem(a)},awardAchievements:function(){for(var a=[],b=0;b<this.achievementsList.length;b++)!this.hasAchievement(this.achievementsList[b].name)&&this.achievementsList[b].check()&&(localStorage.setItem(this.achievementsList[b].name,true),a.push(this.achievementsList[b]));return a},getAchievementsList:function(){return this.achievementsList}}})();(function(){lightBot.ui={showWelcomeScreen:function(a){lightBot.ui.media.playMenuAudio();a==null&&history.pushState({page:"welcomeScreen"});$("title").text("Lightbot - Welcome");$(".ui-screen").hide();$("#welcomeScreen").show()},showHelpScreen:function(a){lightBot.ui.media.playMenuAudio();a==null&&history.pushState({page:"helpScreen"});$("title").text("Lightbot - Help");$(".ui-screen").hide();$("#helpScreen").show()},showAchievementsScreen:function(a){lightBot.ui.media.playMenuAudio();var b=false;
$("#achievementsList").empty();for(var d=lightBot.achievements.getAchievementsList(),c=0;c<d.length;c++)b=lightBot.achievements.hasAchievement(d[c].name)?true:false,$('<li class="'+(b?"":"ui-state-disabled")+'"><img src="img/achievements/'+d[c].name+'.png"><h3>'+d[c].title+"</h3><p>"+d[c].message+"</p></li>").appendTo("#achievementsList");a==null&&history.pushState({page:"achievementsScreen"});$("title").text("Lightbot - Achievements");$(".ui-screen").hide();$("#achievementsScreen").show()},showLevelSelectScreen:function(a){lightBot.ui.media.playMenuAudio();
$("#levelList").empty();for(var b=0;b<lightBot.map.getNbrOfLevels();b++){var d=parseInt(localStorage.getItem("lightbot_level_"+b),10),c="";if(d){switch(d){case lightBot.medals.gold:c="medal-gold";break;case lightBot.medals.silver:c="medal-silver";break;case lightBot.medals.bronze:c="medal-bronze";break;case lightBot.medals.noMedal:break;default:console.error('Unknown medal "'+c+'"')}$('<li class="ui-state-highlight"><span class="medal '+c+'" style="position: absolute; bottom: 2px; right: 0px"></span><span>'+
b+"</span></li>").appendTo("#levelList")}else $("<li>"+b+"</li>").appendTo("#levelList")}a==null&&history.pushState({page:"levelSelectScreen"});$("title").text("Lightbot - Level Select");$(".ui-screen").hide();$("#levelSelectScreen").show()},showGameScreen:function(a,b){lightBot.ui.media.playGameAudio();lightBot.map.loadMap(a);b==null&&history.pushState({page:"gameScreen",level:a});$("title").text("Lightbot - Level "+a);$(".ui-screen").hide();$("#programContainer li").remove();$("#programContainer ul").append('<li class="ui-state-default placeholder"><p class="placeholder">Drop your instructions here</p></li>');
$("#runButton").button("option",{label:"Run",icons:{primary:"ui-icon-play"}}).removeClass("ui-state-highlight");$("#gameScreen").show()}}})();window.onpopstate=function(a){if(a.state===null)lightBot.ui.showWelcomeScreen(true);else switch(a.state.page){case "welcomeScreen":lightBot.ui.showWelcomeScreen(true);break;case "helpScreen":lightBot.ui.showHelpScreen(true);break;case "achievementsScreen":lightBot.ui.showHelpScreen(true);break;case "levelSelectScreen":lightBot.ui.showLevelSelectScreen(true);break;case "gameScreen":lightBot.ui.showGameScreen(a.state.level,true);break;default:console.error("Unknown history page: "+a.state.page)}};$(document).ready(function(){$("#audioPlayer").jPlayer({ready:function(){$(this).jPlayer("setMedia",lightBot.ui.media.audio.menu).jPlayer("play")},swfPath:"js",supplied:"mp3",loop:true,solution:"flash, html",cssSelectorAncestor:"#audioContainer"});$("#videoPlayer").jPlayer({ready:function(){$(this).jPlayer("setMedia",lightBot.ui.media.video[0])},swfPath:"js",supplied:"webmv, ogv, m4v",preload:"metadata",cssSelectorAncestor:"#videoContainer",backgroundColor:"#000000",size:{width:"400px",height:"285px",
cssClass:"jp-video-285p"}});lightBot.ui.media.audioPlayer=$("#audioPlayer");lightBot.ui.media.videoPlayer=$("#videoPlayer")});
(function(){lightBot.ui.media={audioPlayer:null,videoPlayer:null,audio:{menu:{mp3:"media/audio/menu.mp3"},game:{mp3:"media/audio/game.mp3"}},video:[{webmv:"media/video/goal.webm",m4v:"media/video/goal.mp4",ogv:"media/video/goal.ogv"},{webmv:"media/video/howto.webm",m4v:"media/video/howto.mp4",ogv:"media/video/howto.ogv"},{webmv:"media/video/demo.webm",m4v:"media/video/demo.mp4",ogv:"media/video/demo.ogv"},{webmv:"media/video/demo.webm",m4v:"media/video/demo.mp4",ogv:"media/video/demo.ogv"},{webmv:"media/video/demo.webm",
