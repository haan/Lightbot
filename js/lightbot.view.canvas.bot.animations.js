(function() {
  var animations = {
    stand: {
      ...
      duration: 20, // # of steps the entire animation lasts. for non-looping animations, if the duration is larger than (totalFrames * step), the last frame is displayed until the end
      width: 80,
